...
if (isset($_POST['name']) && $_POST['description'] !== ""){
    ...
    $result = insertIntoTable($pdo, $tableName, $data);
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-warning">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" action="create.php" name="frmcreate_cat" method="post">
                            <!-- text input -->
                            <div class="form-group">
                                <label>نام دسته بندی</label>
                                <input type="text" class="form-control" placeholder="نام دسته بندی خود را وارد کنید ..." name="name">
                            </div>
                            ...
                            <div class="form-group">
                                <label>توضیحات</label>
                                <textarea class="form-control" rows="3" placeholder="توضیحاتی درباره دسته بندی خود وارد کنید ..." name="description"></textarea>
