...
if(
    ...
    if($results !== false && $image_upload !== false)
    {
        ...
        $data = [
         ...
         insertIntoTable($pdo, $tableName, $data);
    }

 redirect('views/adminpanel/pages/post/index.php');
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="<?= url('views/adminpanel/pages/post/create.php') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="form-group">
                            ...
                            <textarea class="form-control" name="body" id="body" rows="5" placeholder="متن پست ..."></textarea>
                        </section>
                        <section class="form-group">
